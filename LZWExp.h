 ...
 * sequences and an anonymous state object for the DataSink. If sink
 * requires no state, than sinkState may be NULL. Recyclecode indicates
 * which code to recycle the dictionary on. */
